...
def process_files(forms_df, ups_df):
    ...
    for idx, form_row in forms_df.iterrows():
        ...
        if is_same_billing == "yes":
            ...
            upload_template_rows.append({
                ...
                "Address_Line2": "",  # blank as per sample
                "City": city,
            ...
            # Add billing address (expand to 01, 06, 03 with invoice option 1, 2, 6)
            upload_template_rows.append({
                "AC_NUM": form_row["Account Number"],
                "AC_Address_Type": "01",
                "invoice option": "",
    ...
    # Ensure all expected columns exist in upload template before reordering
